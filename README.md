...
Cost Overview             |  Pod-Histoy
:-------------------------:|:-------------------------:
![overview](./docs/static/img/costreporting.png)  |  ![pod-history](./docs/static/img/pod-history.png)
...
```sh
helm show values spendemon/spendemon --version 1.1.2 > values.yaml
